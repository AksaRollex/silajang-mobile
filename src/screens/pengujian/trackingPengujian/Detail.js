            ...
            {sortedTrackings.length > 0 ? (
              sortedTrackings.map((tracking, index) => (
                <Animated.View
                  ...
                  <View className=" flex-row flex w-full p-3 rounded-lg relative z-10">
                    <View
                    ...
                    <View className="flex-1 z-0">
                      <View className="flex-row justify-between items-center mb-2">
                        <View className="gap-x-2 flex-row w-full justify-between">
                        ...
                        :
                          ...
                          <Text className="text-base font-poppins-medium text-end  text-gray-700">

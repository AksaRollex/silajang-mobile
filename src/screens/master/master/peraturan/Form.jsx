...
export default memo(function Form({ route, navigation }) {
  ...
  const { mutate: createOrUpdate, isLoading } = useMutation(
    async data => {
      ...
      axios.post(
        uuid ? `/master/peraturan/${uuid}/update` : "/master/peraturan/store",
        formData,
        {
          headers: {
      ...
      <View
        ...
        style={{ backgroundColor: "#fff" }}>
          <IonIcon
            ...
            color="#312e81"
          />
          <Text className="font-poppins-semibold text-lg ml-3">
      ...
      <View className="bg-white rounded m-3">
        ...
        <View className="p-5 flex-col space-y-4">
          ...
          <TouchableOpacity
            ...
            className="rounded-md flex-row justify-center p-3 space-x-3 items-center bg-red-700">
